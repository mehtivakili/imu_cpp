...
// this part added for serial communication
  struct DPL{
  int8_t h1;
  int8_t h2;
  int8_t h3;
...
union{
  struct DPL Data;
  uint8_t buffer[12]; // 8 is added to acount for the Time stamps
  }USB_Packet;
...
#define DEVICE_ADDRESS "02:00:00:00:00:00:02:02"
...
void newRange() {
  ...
  */
  ...
  USB_Packet.Data.range=DW1000Ranging.getDistantDevice()->getRange()+0.00000000;
  USB_Packet.Data.TimeStamp = stamp;
  Serial.write(USB_Packet.buffer, sizeof(USB_Packet.buffer));
//  Serial.print(sizeof(DW1000Ranging.getDistantDevice()->getRange()+0.00000000));
  // Update links
  #ifdef IS_TAG
...
void setup() {
  ...
  // #endif
    ...
    DW1000Ranging.startAsTag(DEVICE_ADDRESS, DW1000.MODE_LONGDATA_RANGE_ACCURACY,true);
    // Update the display
